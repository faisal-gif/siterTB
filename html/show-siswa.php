                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <input type="hidden" name="page" value="show-siswa">
                            <input type="text" placeholder="Search..." class="form-control" name="search" value="<?php echo $src ?>"> <i class="fa fa-search"></i></a> 
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $count=0;
                                        if (isset($_GET['search'])) {
                                            $qsch = mysqli_query($conn,"select*from siswa where nama_siswa like '%".$src."%' ");
                                    ...
                                    <td ><?php echo $tampil[6];?></td>
                                    <td><?php echo"<a href='edit-siswa.php?id=$tampil[0]'>Update</a>"; ?></td>
                                        </tr>
                                           <?php
                                            }
                                        }else{
