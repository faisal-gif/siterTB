    ...
    ?>
                ...
                <!-- .row -->
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="POST" action="a/update_guru.php">
                                <h1 align="center"> Guru </h1>
                                <div class="form-group">
                                    <label class="col-md-12">NIP</label>
                                    <div class="col-md-12">
                                        <input type="text" type="text" name="nip" placeholder="NIP" class="form-control form-control-line" value="<?php echo $row['nip'];?>"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Nama Guru</label>
                                    <div class="col-md-12">
                                        <input type="text" type="text" name="nama_guru" placeholder="Nama" class="form-control form-control-line" value="<?php echo $row['nama_guru'];?>"> </div>
                                </div>
                                <div class="form-group">
