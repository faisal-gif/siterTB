             ...
             <!-- /.row -->
                <!-- .row -->
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="POST" action="a/update_siswa.php">
                                <h1 align="center"> Siswa </h1>
                                <div class="form-group">
                                    <label class="col-md-12">NIS</label>
                                    <div class="col-md-12">
                                        <input type="text" type="text" name="nis" placeholder="NIS" class="form-control form-control-line" value="<?php echo $row['nis'];?>"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Nama Siswa</label>
                                    <div class="col-md-12">
                                        <input type="text" type="text" name="nama_siswa" placeholder="Nama" class="form-control form-control-line" value="<?php echo $row['nama_siswa'];?>"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Alamat</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Alamat" class="form-control form-control-line" name="alamat" id="alamat" value="<?php echo $row['alamat'];?>"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-12">Jenis Kelamin</label>
                                    <div class="col-sm-12">
                                        <select class="form-control form-control-line" name="jenis_kelamin" value="<?php echo $row['jenis_kelamin'];?>" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control form-control-line" name="agama" value="<?php echo $row['agama'];?>">
                                            <option>Islam</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Alamat" class="form-control form-control-line" name="nama_orangtua" id="alamat" value="<?php echo $row['nama_orangtua'];?>"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Phone No</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="(+62)" class="form-control form-control-line" name="no_telp" value="<?php echo $row['no_telp'];?>"> </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
